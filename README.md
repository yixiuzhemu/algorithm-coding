...
>>## 2、KMP算法的实现
>>>* .[(1)KMP算法的实现](./coding/src/main/java/com/ly/algorithm/coding/KmpCoding.java "search")
>>## 3、KMP算法的应用
>

># [十一、Manacher算法及其扩展](./coding/src/main/java/com/ly/algorithm/coding/ "./coding/src/main/java/com/ly/algorithm/coding/")
 
># [十二、Morris遍历及其扩展](./coding/src/main/java/com/ly/algorithm/coding/ "./coding/src/main/java/com/ly/algorithm/coding/")

># [十三、线段树](./coding/src/main/java/com/ly/algorithm/coding/ "./coding/src/main/java/com/ly/algorithm/coding/")

># [十四、打表技巧](./coding/src/main/java/com/ly/algorithm/coding/MakeTableCoding.java "./coding/src/main/java/com/ly/algorithm/coding/MakeTableCoding.java")
>>## 1、打表技巧
>>>* (1).问题如果返回值不多，可以用hardcode的方式列出，作为程序的一部分。
>>>* (2).一个大的问题解决时，底层频繁使用规模不大的小问题的解，如果小问题的返回值满足条件1，可以把小问题做成一张表，作为程序的一部分。
>>>* (3).打表找规律
>>## 2、打表技巧算法示例
>>>* [(1)买苹果](./coding/src/main/java/com/ly/algorithm/coding/MakeTableCoding.java "minBagAwsome")
>>>* [(2)牛羊吃草](./coding/src/main/java/com/ly/algorithm/coding/MakeTableCoding.java "fastEat")
>>>* [(3)连续正数和](./coding/src/main/java/com/ly/algorithm/coding/MakeTableCoding.java "isContinuationSum")


># [十五、矩阵处理技巧](./coding/src/main/java/com/ly/algorithm/coding/MatrixCoding.java "./coding/src/main/java/com/ly/algorithm/coding/MatrixCoding.java")
>>## 1、矩阵处理技巧
>>>* (1).zigzag打印矩阵。
>>>* (2).转圈打印矩阵。
>>>* (3).原地旋转正方形
>>## 2、矩阵处理技巧算法示例
>>>* [(1)zigzag打印矩阵](./coding/src/main/java/com/ly/algorithm/coding/MatrixCoding.java "printMatrixZigZag")
>>>* [(2)转圈打印矩阵](./coding/src/main/java/com/ly/algorithm/coding/MatrixCoding.java "printCycle")
>>>* [(3)原地旋转正方形](./coding/src/main/java/com/ly/algorithm/coding/MatrixCoding.java "rotate")
